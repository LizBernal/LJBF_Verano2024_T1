def generar_tabla_distribucion_frecuencias(datos, lim_inf, lim_sup, marcas_clase, fa, fr, fatum):
  ...
  # Cuerpo de la tabla
  cuerpo_tabla = ""
  for i, (clase, lim_inf_valor, lim_sup_valor, marca_clase_valor, fa_valor, fr_valor, fatum_valor) in enumerate(zip(range(len(lim_inf) + 1), lim_inf, lim_sup, marcas_clase, fa, fr, fatum)):
